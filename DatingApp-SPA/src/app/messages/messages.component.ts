...
export class MessagesComponent implements OnInit {
  ...
  loadMessages() {
    this.userService.getMessages(this.authService.decotedToken.nameid, this.pagination.currentPage,
  ...
  deleteMessage(id: number) {
    this.alertify.confirm('Are you sure you want to delete this message', () => {
      this.userService.deleteMessage(id, this.authService.decotedToken.nameid).subscribe(() => {
        ...
        this.alertify.success('Message has been deleted successefully');
      }, error => {
